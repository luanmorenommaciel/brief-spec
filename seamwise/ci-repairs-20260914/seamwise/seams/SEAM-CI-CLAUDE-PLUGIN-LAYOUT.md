...
kind: seam
claim: derived
id: SEAM-CI-CLAUDE-PLUGIN-LAYOUT
name: Separate repository Claude memory from plugin-root content
description: Current strict Claude validation warns that root CLAUDE.md is not loaded as plugin context.
  The file contains only @OPERATING.md. Official memory documentation supports .claude/CLAUDE.md and resolves
  imports relative to that file.
evidence:
- EVIDENCE-CI-CLAUDE-PLUGIN-LAYOUT
responsibility: Preserve the repository operating import in the officially supported .claude/CLAUDE.md
...
swimlane:
  id: LANE-CI-CLAUDE-PLUGIN-LAYOUT
  name: Separate repository Claude memory from plugin-root content
  owner: brief-spec
  legs:
  - id: LEG-CI-CLAUDE-PLUGIN-LAYOUT
    ...
    - id: T-20260914-briefspec-ci-claude-plugin-layout
      ...
      - id: B-1
        ...
        then: The existing OPERATING.md instructions remain reachable through .claude/CLAUDE.md with the
...
Current strict Claude validation warns that root CLAUDE.md is not loaded as plugin context. The file contains only @OPERATING.md. Official memory documentation supports .claude/CLAUDE.md and resolves imports relative to that file.
