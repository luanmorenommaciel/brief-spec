...
kind: seam
claim: derived
id: SEAM-TERMINAL-OBLIGATIONS
name: Preserve stop obligations before clearing state
description: Evaluate typed outcome obligations against pre-stop state and validate explicitly requested
...
responsibility: Required typed outcomes and requested checkpoint modes cannot be skipped by clearing flags
  too early, and every repair path remains bounded.
consumes:
...
swimlane:
  ...
  - id: LEG-TERMINAL-OBLIGATIONS
    ...
    - id: T-20260914-briefspec-terminal-obligations
      ...
      goal: Evaluate typed outcome obligations against pre-stop state and validate explicitly requested
        checkpoint mode before clearing state. Preserve exactly one repair and the intentional Grok completed-brief
        release behavior.
      ...
      - id: B-1
        ...
        when: Evaluate typed outcome obligations against pre-stop state and validate explicitly requested
          checkpoint mode before clearing state. Preserve exactly one repair and the intentional Grok
          completed-brief release behavior.
        then: Required typed outcomes and requested checkpoint modes cannot be skipped by clearing flags
          too early, and every repair path remains bounded.
      - id: B-2
